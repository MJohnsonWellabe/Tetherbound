...
Use ROADMAP §3's session sequence: the first ownership session covers F01–F04, then each next session takes F05 through F15 in order. Continue an unfinished batch from STATE; advance only on merged acceptance evidence.
