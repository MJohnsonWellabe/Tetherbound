...
>
> Read it alongside `docs/specs/MEADOWS_PROGRESSION_SPEC.md` (D23): that one says what
...
- All third-party assets must be recorded in `docs/specs/ASSET_LEDGER.md` before commit.
...
1. Read `docs/specs/ASSET_LEDGER.md`.
...
5. Record it in `docs/specs/ASSET_LEDGER.md` **before commit**.
...
1. Audit current repo environment packs and `docs/specs/ASSET_LEDGER.md`.
