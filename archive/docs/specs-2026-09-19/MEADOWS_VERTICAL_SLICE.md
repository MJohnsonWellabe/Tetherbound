...
**Scope extended by `docs/specs/MEADOWS_PROGRESSION_SPEC.md` (`docs/decisions/D23`).**
...
512 m playground cannot hold that — `docs/CURRENT_STATE.md`'s `R7.3` owns the growth
and the rebake.
