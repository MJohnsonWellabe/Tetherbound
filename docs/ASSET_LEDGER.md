...
| Nature Kit — 27 models | Kenney | [Nature Kit](https://kenney.nl/assets/nature-kit) | CC0 1.0 | No | `assets/environment/nature/*.glb` | Curated subset of 329; trees, bushes, grass, flowers, rocks, logs. Retinted at run time by material name into the project palette (`vegetation.gd`). |
| Grass004 — colour, normal, roughness | ambientCG | [ambientCG Grass004](https://ambientcg.com/view?id=Grass004) | CC0 1.0 | No | `assets/environment/terrain/Grass004_*.jpg` | 2K JPG. Fed to Terrain3D's auto shader as the base ground layer. |
