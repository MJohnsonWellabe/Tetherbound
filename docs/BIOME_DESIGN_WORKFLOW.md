...
- `docs/biomes/BIOME_XX_DESIGN.md` — complete authoritative design record.
- `docs/biomes/BIOME_XX_PROGRESS.md` — simple progress tracker suitable for a child to understand.
