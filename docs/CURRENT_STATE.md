...
| Performance on the ROG Ally | Unable to verify | no container can measure it; perf proxy: band1_open 6897 draws / 10.80M prims (GRASS-CULL-0903: was 6947 / 11.79M — tile culling now actually excludes tiles; see §3) under provisional budget |
