...
|---|---|---|
| First expedition | One brief 15–30-minute owner check of the existing loop: readable fight, meaningful team choice, useful detour/preparation and desire to continue. | Fix the observed blocker or select one justified mechanic; no new cohort or harness programme. |
| Complete Meadows | Earned route without a duration floor; 4/5 want to continue; no blocker/coerced grind; two accepted visual subject/domain improvements visible in motion. | Fix pacing/combat/payoffs or stop rather than add biomes. |
...
| Launch quality | Five novice campaign clears and two four-peer clears without blocker; reported measured duration, with eight good hours acceptable; 4/5 novice finishers would recommend to target players. | Delay; a finite campaign must finish reliably. |
