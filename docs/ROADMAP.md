...
| 1.3 | **Bram's shop exit** clips furniture on the straight-line walk out. | Sonnet | `scripts/world/shop_interior.gd`, the exit probe | interact-driven exit lands outside the doorway 10/10 |
