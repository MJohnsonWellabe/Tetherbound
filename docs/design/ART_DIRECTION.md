...
| **Stormwood** | Cool blue-green moss from below, copper and glass highlights, black reflective pools, white-violet lightning; little direct sky until the aftermath; after release, rain lightens and lightning stops, the purple sky stays and the scars remain (owner ruling). | Giant old trunks, glass-fused scars, copper vines, wet roots, fungi, rod-line scaffolds and Stormglass arches. Safe places are visibly calm and grounded. | The rod line and Dynamo grow as the destination; Surge phase and safe radius remain legible in motion. After release, sky and ordinary forest colour return without erasing scars. |
