...
| Creature art | **Mixed stand-ins, generated exceptions and installed replacements.** Shared material/colourway systems exist. | Final style selection, owner references, a three-creature proof at real camera distance, topology/rig/animation repairs, mipmaps and slope/contact validation. |
