...
Because terrain placement + NPC appearance is visual-affecting, capture representative frames and run the normal blind visual-judge pass required by `docs/AGENT_WORKFLOW.md`.
