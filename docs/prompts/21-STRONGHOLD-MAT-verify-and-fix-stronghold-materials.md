...
Run relevant stronghold smoke tests and `smoke_art` if applicable. Because this is visual-affecting, capture representative frames and follow `docs/AGENT_WORKFLOW.md` blind visual-judge convergence using `docs/reference/tetherbound-meadows-keyart.png` as primary world target. Judge palette, landmark language and mood—not pixel fidelity.
