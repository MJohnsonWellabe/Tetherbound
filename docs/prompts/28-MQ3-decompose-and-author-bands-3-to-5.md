...
## Visual bar
Use `docs/reference/tetherbound-meadows-keyart.png` as primary world direction and Palworld references only for real-time density/readability. Every visual subtask follows `docs/AGENT_WORKFLOW.md` capture + blind visual-judge convergence.
