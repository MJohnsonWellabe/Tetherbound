...
- `docs/MEADOWS_MACRO_LAYOUT.md`
- `docs/MEADOWS_PROGRESSION_SPEC.md`, especially the reveal ladder / Team Tether environmental-storytelling sections
...
This is visual-affecting world work, so follow `ralph/conventions.md`:
