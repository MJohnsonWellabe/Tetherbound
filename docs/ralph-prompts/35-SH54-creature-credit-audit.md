...
## Canonical rule
`CLAUDE.md`, `ralph/conventions.md`, D23/spec §20 explicitly prohibit new Meadows creature meshes/generations. Credits available do not lift the rule. Existing creatures may be differentiated through material, palette, modest scale, animation, VFX, habitat and behavior.
...
- references in `ralph/BACKLOG.md`, planning docs, BLOCKED/NOTES, Ralph prompts and decisions that request or imply a fresh Meadows creature generation;
