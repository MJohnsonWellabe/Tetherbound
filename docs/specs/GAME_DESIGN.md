...
`docs/specs/MEADOWS_PROGRESSION_SPEC.md` §23–§31: the eight legendaries are living
...
`docs/specs/MEADOWS_PROGRESSION_SPEC.md` sits inside this section's own 4–8 hour
...
`docs/CURRENT_STATE.md`'s `R9.5`, `R0.11`, `R2.9`, `R4.12` and `R6.3` all cite them
by number, and renumbering would silently break every one of those citations.
`docs/specs/MEADOWS_PROGRESSION_SPEC.md` §39 adds a **second, chapter-level gate**
