...
- **Village layout**: characters read too small now; shape still doesn't make sense especially around Grandpa's house; Mira is hidden inside a house instead of being findable. Triaged in `ralph/reports/FIX-OWNER-0902-VILLAGE-READABILITY-2026-09-02.md` (branch `ralph/OWNER-0902-VILLAGE-READABILITY`, not merged): the "too small" read traced to the 09-01 creature-scale growth (`OD-0901-1`/`OD-0901-2`), not a villager regression — needs an owner call, not a guess, and separately reopens the never-resolved VIS-CAST adult-vs-youth question; the Grandpa's-house road endpoint was found sitting a metre inside the house's own wall (fixed, data-only); Mira got an exterior shop sign rather than being moved back outside (OF31's "store in his house" stands). None of this is render-verified — no Godot binary was available this session.
