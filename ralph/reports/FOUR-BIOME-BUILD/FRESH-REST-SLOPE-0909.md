...
The reviewed narrow candidate and its focused pure regression subsequently passed once: `tests/run_tests.gd -- --only=vegetation_human_prompt_height` ran 3 tests and 24 assertions with 0 failures. Raw console `.artifacts/stone-human-prompt-unit-20260909/console.log` has SHA-256 `3524ee09045b80ac9d0d10ece90e5d316dc0b11e638d7e683d0b747cced3197b`; `result.json` has SHA-256 `a5528d32431321e0953341fdb60b0d6cfde18eb6de11e5dccafff51975366f9f`. The test spawns the real harvest-point/Interactable object and checks its position/radius geometry, but the repository's pure test runner has no live SceneTree and therefore does not call the live arbiter offer path.
