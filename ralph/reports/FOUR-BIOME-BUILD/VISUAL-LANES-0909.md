...
| Meadows | Flowers/clover/night-shadow and fitted Relay gate held. Both gate route attempts failed | Separate cable supports passed23 actual-node assertions and guarded4-frame matched capture, exit0. Neutral Wave15 review pending; no gate/route acceptance |
| Water | First Shore gate/dock and Veilfall held. Gull Rest custom capture sequence failed twice and remains retained | Changed strategy uses unchanged mature catalogue pipeline: first canonical day/night pair complete2/2, no engine errors; engineexit receipt null. Wave16 pending, no adjacent traversal acceptance |
