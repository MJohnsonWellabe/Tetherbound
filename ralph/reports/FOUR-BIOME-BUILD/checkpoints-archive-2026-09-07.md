# Four-biome build checkpoints — archive (2026-09-07 session)

Archived from `checkpoints.md` on 2026-09-09 so the live file's read cost stays bounded on every fresh orientation pass. Covers Checkpoints 0-15 plus the 09:08/11:00/11:25 UTC 2026-09-08 entries -- the original four-biome Wave 0 session through its owner-requested wrap, immediately before PR #80 merged and Wave 1 began. Live, current-campaign checkpoints are in `checkpoints.md`. Read this file only if you need pre-merge history.
