...
- predicted cost 1057 s over 176338 frames at 0.0060 s/frame (re-priced after each boot)
...
- actual: seeded slot 4 from ralph/reports/G3-BAND3-0903/gate-f-s07-v4/S06/saves/S06-exit.json (1420151 bytes)
- events: t=0.25
- verdict: PASS
...
- actual: booted title in 464 ms (30 settle frames); re-priced at boot:title: 0.0065 s/frame (was 0.0060), 176305 frames left + 0 s boot = 1149 s against 14399 s of budget left
- events: t=0.88
- verdict: PASS
...
- actual: map opened the shell: context world -> menu_map, focus on '' (@Control@65489)
- events: t=182.42
- verdict: PASS
...
- actual: walked 509.4 m to (0, 2980) in 6442 walking frames (0 held)
- events: t=290.35
- verdict: PASS
...
- actual: walked 539.3 m to (150, 3500) in 6834 walking frames (0 held)
- events: t=551.47
- verdict: PASS
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: walked 204.6 m to (241, 3680) in 2496 walking frames (0 held)
- events: t=593.08
- verdict: PASS
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
### S07-32 — fight Hess
- expected: Section E.1 per-fight record
- actual: fought 1191 frames: 33 quick, 0 handover(s), 0 refused switch(es); ended because flag 'defeated_relay_hess' set, SET 'defeated_relay_hess'
- events: t=625.98
- verdict: PASS
...
- actual: walked 54.2 m to (284, 3710) in 1068 walking frames (0 held)
- events: t=651.80
- verdict: PASS
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
### S07-38 — fight Orrin
- expected: Section E.1 per-fight record
- actual: fought 951 frames: 30 quick, 0 handover(s), 0 refused switch(es); ended because flag 'defeated_relay_orrin' set, SET 'defeated_relay_orrin'
- events: t=680.38
- verdict: PASS
...
- actual: walked 79.7 m to (342, 3772) in 1180 walking frames (0 held)
- events: t=708.07
- verdict: PASS
...
- actual: walked 2.1 m to (343, 3771) in 25 walking frames (0 held)
- events: t=708.50
- verdict: PASS
...
### S07-47 — fight Dell
- expected: Section E.1 per-fight record
- actual: fought 2695 frames: 74 quick, 1 handover(s), 0 refused switch(es); ended because flag 'defeated_relay_dell' set, SET 'defeated_relay_dell'
- events: t=767.17
- verdict: PASS
...
- actual: walked 15.4 m to (352, 3757) in 356 walking frames (0 held)
- events: t=781.12
- verdict: PASS
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: walked 8.1 m to (356, 3753) in 95 walking frames (0 held)
- events: t=887.57
- verdict: PASS
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: walked 6.9 m to (350, 3760) in 171 walking frames (0 held)
- events: t=900.38
- verdict: PASS
...
- actual: FAIL did not reach (-152, 4196) in 31500 walking frames; stopped 661.2 m short at (345.0, 5.0, 3759.0) (40 held)
- events: t=1435.37
- verdict: FAIL
...
- actual: walked 2115.7 m this segment (wanted >= 2200.0)
- events: t=1442.65
- verdict: FAIL

### S07-82 — the 2 Hz trace ran throughout
- expected: Section C.2
- actual: route.csv has 2515 rows (wanted >= 3000)
- events: t=1442.65
- verdict: FAIL
...
- actual: dead_travel peaked at 495.5 m this segment (wanted >= 150.0); 2115.7 m walked in total
- events: t=1442.65
- verdict: PASS
...
- actual: map opened the shell: context world -> menu_map, focus on '' (@Control@71251)
- events: t=1442.82
- verdict: PASS
...
- actual: 4 x ui_down moved focus 'Save' (@Button@71301) -> 'Save' (@Button@71321)
- events: t=1444.70
- verdict: PASS
...
- actual: slot 4 copied to saves/S07-exit.json (1420488 bytes)
- events: t=1447.17
- verdict: PASS
