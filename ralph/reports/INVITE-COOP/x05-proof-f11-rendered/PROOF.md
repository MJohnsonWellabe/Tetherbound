...
Run: `net-20260925T165430Z-21513`  
Rendered: yes
...
| 3 | 0 | host | PASS | PASS | hosting udp/31901 as peer 1 |
| 4 | 1 | join | PASS | PASS | joined 127.0.0.1:31901 as peer 439018580 after 12 frames; snapshot applied; 2 peer(s) in registry |
...
| 7 | 0 | enter_realm — host first: its shell builds inside its own step | PASS | PASS | crossed 'meadows' -> 'stormwood' after 484 observed physics frames / 45490 ms (budget 6000 physics frames); current scene is /root/Stormwood |
| 8 | 1 | enter_realm | PASS | PASS | crossed 'meadows' -> 'stormwood' after 506 observed physics frames / 29507 ms (budget 6000 physics frames); current scene is /root/Stormwood |
...
| 10 | 1 | capture_saves | PASS | PASS | client (character only): autosave_here()=false, character 'character-a54501ba12e7c373e96228dab4e94789' on disk=true; copied 1 files to peer-1/before |
| 11 | 0 | stormheart_fixture — both fought the Dynamo (setup) | PASS | PASS | Dynamo contributors [1, 439018580]; committed ["stormwood:act_ii_complete", "stormwood:marrow_defeated"] |
| 12 | 0 | wait_flag | PASS | PASS | flag stormwood:legendary_freed (any) set after 0 frames |
| 12 | 1 | wait_flag | PASS | PASS | flag stormwood:legendary_freed (any) set after 1180 frames |
...
| 16 | 0 | wait_flag | PASS | PASS | flag stormwood:legendary_resolution:refused:character-a54501ba12e7c373e96228dab4e94789 (any) set after 0 frames |
| 16 | 1 | wait_flag | PASS | PASS | flag stormwood:legendary_resolution:refused:character-a54501ba12e7c373e96228dab4e94789 (any) set after 67 frames |
...
| 20 | 1 | capture_saves | PASS | PASS | client (character only): autosave_here()=false, character 'character-a54501ba12e7c373e96228dab4e94789' on disk=true; copied 1 files to peer-1/after |
...
| 24 | 1 | check_saved — guest's saved character refused and holds none | PASS | PASS | missing []; unexpectedly present []; read ["character-a54501ba12e7c373e96228dab4e94789/character.json"] under after/characters |
| 25 | 1 | check_saved — guest's pre-offer save held no answer (non-vacuous baseline) | PASS | PASS | missing []; unexpectedly present []; read ["character-a54501ba12e7c373e96228dab4e94789/character.json"] under before/characters |
...
- `peer-1/after/characters/character-a54501ba12e7c373e96228dab4e94789/character.json`
- `peer-1/before/characters/character-a54501ba12e7c373e96228dab4e94789/character.json`
