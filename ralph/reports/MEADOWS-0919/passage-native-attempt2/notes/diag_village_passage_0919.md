...
- predicted cost 12 s over 15144 frames at 0.0006 s/frame (re-priced after each boot)

### D01 — wipe_saves
- expected: Isolated diagnostic profile has no competing slots
- actual: save directory D:/tetherbound/closeout-profiles/passage-0919-attempt2/Roaming/Godot/app_userdata/Tetherbound/saves does not exist yet; nothing to wipe
- events: t=0.25
- verdict: PASS
...
### D03 — boot
- expected: Real title
- actual: booted title in 511 ms (30 settle frames); re-priced at boot:title: 22274 physics waits at 0.01454 s, 67 process waits at 0.00050 s and 0.0 fixed seconds = 324 s against 14399 s remaining
- events: t=0.77
- verdict: PASS
...
- actual: selected wild began a verified live fight during physical approach after 1606 walking frames (0 held); no interact pressed
- events: t=30.05
- verdict: PASS
...
- actual: combat_running=true (wanted false) [still false after 180 physics frames]
- events: t=33.67
- verdict: FAIL

### D11 — move_to
- expected: Return physically through an open gate within same budget
- actual: walked 75.7 m to (46, -43) in 1790 walking frames (678 held)
- events: t=74.82
- verdict: PASS
