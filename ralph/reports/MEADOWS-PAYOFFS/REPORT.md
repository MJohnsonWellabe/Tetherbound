...
- `smoke_warrens.gd --vault-activity` **exited 1** with three failures: the Heartstone interaction did not settle its item and flag, save/load lost the Elder or Heartstone once flag, and save/load recreated the consumed Heartstone.
