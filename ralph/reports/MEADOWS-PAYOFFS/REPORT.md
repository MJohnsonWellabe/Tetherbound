...
- `smoke_local_requests.gd` (all activities in one session, Doss last): `local requests smoke test passed`. Doss's order-dependent repeat failure recorded at 47774c350 did not recur in this logged run (earlier unlogged passes on 835744b35, 2049ff283 and fe07d0d28 are not receipts).
