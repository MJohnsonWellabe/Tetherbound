...
Scenario: `/home/user/tetherbound/tools/net/proof_scenarios/f14_guardian_offer_capacity_space.json`  
Run: `net-20260926T010900Z-4225`  
Rendered: yes
...
|---|---|---|---|---|---|
| 1 | 0 | host | PASS | PASS | hosting udp/28561 as peer 1 |
| 2 | 1 | join | PASS | PASS | joined 127.0.0.1:28561 as peer 813943508 after 6 frames; snapshot applied; 2 peer(s) in registry |
...
| 11 | 1 | guardian_state — setup: the guest's belt is full (five) | PASS + {"guardians_owned":0.0,"party_size":5.0} | PASS | {"character_id":"character-d340e7872967ba6c02b3234c460eeab2","claim_id":"8993fc15fa8a4e365dcca2f6d19056fc76f1a2550178f33e66b1b43c5c913e6d","guardian_freed":false,"guardians_owned":0,"offered":false,"party":["Kestrel","Bramble","Rill","Tuff","Fern"],"party_size":5,"pending_guardian_id":"","receipt_saved":false,"saved_guardians":0,"saved_party_size":0} |
| 12 | 0 | guardian_fixture — setup: both fought Nerissa (the director's own session path journals one reward row each) | PASS | PASS | prerequisites committed ["water_dock_sluice_isle_both_controls_disabled", "water_veilfall_intake_stopped", "water_veilfall_return_opened"]; Nerissa fought by peers [1, 813943508]; session path handled=true; 'water_captain_nerissa_defeated' set=true; participant characters ["character-8f6f34a4d3048841677669db0a47253f", "character-d340e7872967ba6c02b3234c460eeab2"] |
...
| 16 | 0 | screenshot — first rendered frame (shader warm-up under its own allowance) | PASS | PASS | captured 960x540 -> /home/user/tetherbound/ralph/reports/TIDEWAKE/f14_guardian_offer_capacity_space/peer-0/00_guardian_freed.png |
| 16 | 1 | screenshot — first rendered frame (shader warm-up under its own allowance) | PASS | PASS | captured 960x540 -> /home/user/tetherbound/ralph/reports/TIDEWAKE/f14_guardian_offer_capacity_space/peer-1/00_guardian_freed.png |
| 17 | 0 | guardian_state — the host journals both characters as freeing-fight participants | PASS + {"guardian_freed":true,"participants":["character-8f6f34a4d3048841677669db0a47253f","character-d340e7872967ba6c02b3234c460eeab2"]} | PASS | {"character_id":"character-8f6f34a4d3048841677669db0a47253f","claim_id":"1328a9483874db3cecf021d05f64b5ff728b3e88081649046047e350b18a6c0f","guardian_freed":true,"guardians_owned":0,"host_open_claims":[],"host_settled":false,"offered":false,"participants":["character-8f6f34a4d3048841677669db0a47253f","character-d340e7872967ba6c02b3234c460eeab2"],"party":["Acorn","Shelby"],"party_size":2,"pending_guardian_id":"","receipt_saved":false,"saved_guardians":0,"saved_party_size":2} |
...
| 26 | 1 | guardian_state — guest: exactly one Guardian in Rill's holder, the other four kept, receipt saved | PASS + {"guardians_owned":1.0,"party":["Kestrel","Bramble","Abyssal Guardian","Tuff","Fern"],"party_size":5.0,"pending_guardian_id":"","receipt_saved":true,"saved_guardians":1.0,"saved_party_size":5.0} | PASS | {"character_id":"character-d340e7872967ba6c02b3234c460eeab2","claim_id":"8993fc15fa8a4e365dcca2f6d19056fc76f1a2550178f33e66b1b43c5c913e6d","guardian_freed":true,"guardians_owned":1,"offered":true,"party":["Kestrel","Bramble","Abyssal Guardian","Tuff","Fern"],"party_size":5,"pending_guardian_id":"","receipt_saved":true,"saved_guardians":1,"saved_party_size":5} |
| 27 | 0 | guardian_state — host: exactly one Guardian, receipt saved, no claim left open, settled | PASS + {"guardians_owned":1.0,"host_open_claims":[],"host_settled":true,"party":["Acorn","Shelby","Abyssal Guardian"],"party_size":3.0,"receipt_saved":true,"saved_guardians":1.0} | PASS | {"character_id":"character-8f6f34a4d3048841677669db0a47253f","claim_id":"1328a9483874db3cecf021d05f64b5ff728b3e88081649046047e350b18a6c0f","guardian_freed":true,"guardians_owned":1,"host_open_claims":[],"host_settled":true,"offered":true,"participants":["character-8f6f34a4d3048841677669db0a47253f","character-d340e7872967ba6c02b3234c460eeab2"],"party":["Acorn","Shelby","Abyssal Guardian"],"party_size":3,"pending_guardian_id":"","receipt_saved":true,"saved_guardians":1,"saved_party_size":3} |
| 28 | 0 | screenshot | PASS | PASS | captured 960x540 -> /home/user/tetherbound/ralph/reports/TIDEWAKE/f14_guardian_offer_capacity_space/peer-0/03_after.png |
| 28 | 1 | screenshot | PASS | PASS | captured 960x540 -> /home/user/tetherbound/ralph/reports/TIDEWAKE/f14_guardian_offer_capacity_space/peer-1/03_after.png |
| 29 | 0 | capture_saves | PASS | PASS | host (world + character): autosave_here()=true, character 'character-8f6f34a4d3048841677669db0a47253f' on disk=true; copied 3 files to /home/user/tetherbound/ralph/reports/TIDEWAKE/f14_guardian_offer_capacity_space/peer-0/after |
| 29 | 1 | capture_saves | PASS | PASS | client (character only): autosave_here()=false, character 'character-d340e7872967ba6c02b3234c460eeab2' on disk=true; copied 1 files to /home/user/tetherbound/ralph/reports/TIDEWAKE/f14_guardian_offer_capacity_space/peer-1/after |
| 30 | 1 | check_saved — guest's saved character | PASS | PASS | missing []; unexpectedly present []; read ["character-d340e7872967ba6c02b3234c460eeab2/character.json"] under after/characters |
| 31 | 0 | check_saved — host's saved character | PASS | PASS | missing []; unexpectedly present []; read ["character-8f6f34a4d3048841677669db0a47253f/character.json"] under after/characters |
...
- `peer-0/03_after.png`
- `peer-0/after/characters/character-8f6f34a4d3048841677669db0a47253f/character.json`
...
- `peer-1/03_after.png`
- `peer-1/after/characters/character-d340e7872967ba6c02b3234c460eeab2/character.json`
