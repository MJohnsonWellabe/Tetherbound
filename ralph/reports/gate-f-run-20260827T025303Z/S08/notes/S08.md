...
- actual: seeded slot 4 from ralph/reports/gate-f-run-20260827T025303Z/S07/saves/S07-exit.json (1415099 bytes)
- events: t=0.00
- verdict: PASS
...
- actual: tracked objective id=opening:beat:road text=Catch your first wild creature. (wanted defeat_the_captains)
- events: t=235.78
- verdict: FAIL
...
- actual: recording at 0.50 Hz for band 3 -> band 4, the Upper Meadows arrival across the crossing (baseline 0.10 Hz)
- events: t=235.78
- verdict: PASS
...
- actual: capture GF-11-UPPER-01 skipped (headless run); manifest row written with file:null
- events: t=235.78
- verdict: PASS
...
- actual: capture GF-18-MAP-02 skipped (headless run); manifest row written with file:null
- events: t=237.42
- verdict: PASS
...
- actual: map opened the shell: context world -> menu_map, focus on '' (@Control@62809)
- events: t=237.69
- verdict: PASS
...
- actual: FAIL did not reach (-345, 5060) in 45000 walking frames; stopped 3756.0 m short at (4.0, -3.0, 1320.0) (0 held)
- events: t=987.79
- verdict: FAIL
...
- actual: FAIL did not reach (-334, 5055) in 3000 walking frames; stopped 3746.3 m short at (16.0, -5.0, 1325.0) (0 held)
- events: t=1039.57
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: FAIL did not reach (12, 5561) in 36000 walking frames; stopped 4242.8 m short at (16.0, -3.0, 1318.0) (0 held)
- events: t=1652.54
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: capture GF-05-MEADOW-02 skipped (headless run); manifest row written with file:null
- events: t=1652.54
- verdict: PASS
...
- actual: capture GF-14-COMBAT-12a skipped (headless run); manifest row written with file:null
- events: t=1656.06
- verdict: PASS
...
- actual: capture GF-19-UI-09 skipped (headless run); manifest row written with file:null
- events: t=1667.83
- verdict: PASS
...
- actual: map opened the shell: context world -> menu_map, focus on '' (@Control@88901)
- events: t=1668.04
- verdict: PASS
...
- actual: focus_owner=@Button@91681 focus_text=
- events: t=1676.90
- verdict: PASS
...
- actual: FAIL 1 x ui_down did not move focus off @Button@91681
- events: t=1679.01
- verdict: FAIL
...
- actual: capture GF-11-UPPER-02 skipped (headless run); manifest row written with file:null
- events: t=1684.25
- verdict: PASS
...
- actual: FAIL did not reach (170, 5590) in 9000 walking frames; stopped 4272.3 m short at (12.0, -3.0, 1321.0) (0 held)
- events: t=1834.26
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: capture GF-14-COMBAT-04d skipped (headless run); manifest row written with file:null
- events: t=1845.57
- verdict: PASS
...
- actual: FAIL did not reach (-100, 4350) in 63000 walking frames; stopped 3034.5 m short at (8.0, -3.0, 1317.0) (0 held)
- events: t=2921.08
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: recording at 0.50 Hz for band 4's northern region transition, into the Ridgeline Watch (baseline 0.10 Hz)
- events: t=2952.18
- verdict: PASS
...
- actual: FAIL did not reach (-280, 6460) in 99000 walking frames; stopped 5145.9 m short at (16.0, -3.0, 1323.0) (0 held)
- events: t=4602.19
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: FAIL did not reach (-235, 6470) in 3000 walking frames; stopped 5153.6 m short at (17.0, -2.0, 1322.0) (0 held)
- events: t=4652.46
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: FAIL did not reach (-280, 6460) in 3000 walking frames; stopped 5149.6 m short at (11.0, -3.0, 1319.0) (0 held)
- events: t=4722.70
- verdict: FAIL
- observation: answer_prompts turned ON for this journey walk. TRADE RECORDED EXPLICITLY: the schema says this flag must stay off in any segment whose subject is whether something blocks travel, so these segments can no longer evidence 'a narrative modal blocked the player from travelling'. That finding is already captured in full, un-answered, in S02-superseded-2/3/4 and S02/BLOCKER.md -- three press counts, identical 7201-frame holds. What it buys is everything downstream: measured in S03 and S04, an unanswered modal at a walk's end left input_context='narrative_modal' where the next step expected combat, so no fight started, no catch resolved, the team never reached three, and every tournament entry check then failed on team size. Without this the journey produces no combat, catching, building or progression evidence at all.
...
- actual: walked 23794.2 m this segment (wanted >= 4000.0)
- events: t=4753.73
- verdict: PASS

### S08-118 — the 2 Hz trace ran throughout
- expected: Section C.2
- actual: route.csv has 9120 rows (wanted >= 4000)
- events: t=4753.73
- verdict: PASS
...
- actual: dead_travel peaked at 0.4 m this segment (wanted >= 150.0); 23794.2 m walked in total
- events: t=4753.73
- verdict: FAIL
...
- actual: map opened the shell: context world -> menu_map, focus on '' (@Control@151149)
- events: t=4753.97
- verdict: PASS
- observation: Opened via the map shortcut rather than a bare game_menu press. The pause shell REOPENS ON THE LAST TAB USED, so a fixed press count from an assumed backpack start lands on the wrong tab in any segment that opens the menu more than once. Measured in S03: the shell reopened on `menu_map` and 4x menu_tab_right landed on `menu_settings` instead of `menu_build`, failing nine consecutive build steps. `map` is one of only two tabs with a shortcut in data/config/menu.json, so it is the only deterministic starting point available.
...
- actual: 4 x ui_down moved focus 'Save' (@Button@151189) -> 'Save' (@Button@151209)
- events: t=4754.97
- verdict: PASS
...
- actual: slot 4 copied to saves/S08-exit.json (1415072 bytes)
- events: t=4757.23
- verdict: PASS
