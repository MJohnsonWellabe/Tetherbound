...
- predicted cost 855 s over 144519 frames at 0.0059 s/frame (re-priced after each boot)
...
- actual: seeded slot 4 from ralph/reports/gate-f-run-20260828T183531Z/S06/saves/S06-exit.json (1415126 bytes)
- events: t=0.22
- verdict: PASS
...
- actual: booted title in 482 ms (30 settle frames); re-priced at boot:title: 0.0065 s/frame (was 0.0059), 144486 frames left + 0 s boot = 943 s against 14399 s of budget left
- events: t=0.85
- verdict: PASS
...
- actual: walked 9159.5 m this segment (wanted >= 2200.0)
- events: t=2314.32
- verdict: PASS

### S07-82 — the 2 Hz trace ran throughout
- expected: Section C.2
- actual: route.csv has 4606 rows (wanted >= 3000)
- events: t=2314.32
- verdict: PASS
...
- actual: dead_travel peaked at 0.3 m this segment (wanted >= 150.0); 9159.5 m walked in total
- events: t=2314.32
- verdict: FAIL
...
- actual: game_menu opened the shell: context world -> menu_map, focus on '' (@Control@95436)
- events: t=2314.50
- verdict: PASS
...
- actual: 4 x ui_down moved focus @Button@95847 -> @Button@95955
- events: t=2315.85
- verdict: PASS
...
- actual: slot 4 copied to saves/S07-exit.json (1415126 bytes)
- events: t=2317.95
- verdict: PASS
