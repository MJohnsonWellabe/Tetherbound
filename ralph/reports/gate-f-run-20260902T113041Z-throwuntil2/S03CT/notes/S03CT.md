...
- actual: seeded slot 4 from ralph/reports/gate-f-run-20260902T113041Z-throwuntil2/S02/saves/S02-exit.json (1418492 bytes)
- events: t=0.23
- verdict: PASS
...
- actual: booted title in 487 ms (30 settle frames); re-priced at boot:title: 0.0065 s/frame (was 0.0059), 20733 frames left + 0 s boot = 136 s against 14399 s of budget left
- events: t=0.87
- verdict: PASS
...
- actual: walked 6.4 m to bramblebun (species_id, nearest of 64 (Wild_bramblebun_0_1, Wild_bramblebun_0_2, Wild_bramblebun_0_3, Wild_bramblebun_1003_1, Wild_bramblebun_1003_2, Wild_bramblebun_1006_1, ...)) in 73 walking frames (0 held)
- events: t=200.75
- verdict: PASS
...
- actual: 6 x combat_quick: enemy hp 11.4/93.7 (12.2%), hits dealt [13.7, 13.8, 13.2, 14.1, 13.6, 13.9], largest 14.1
- events: t=207.42
- verdict: PASS
...
- actual: FAIL throw_until_caught: could not arm aim for throw 2 (FAIL 3 x interact did not reach it; last saw input_context=combat (wanted combat_aim)) -- prior: throw 1 (tracked)
- events: t=214.67
- verdict: FAIL
