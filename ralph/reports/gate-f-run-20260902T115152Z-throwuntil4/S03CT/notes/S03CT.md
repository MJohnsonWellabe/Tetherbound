...
- actual: seeded slot 4 from ralph/reports/gate-f-run-20260902T115152Z-throwuntil4/S02/saves/S02-exit.json (1418492 bytes)
- events: t=0.23
- verdict: PASS
...
- actual: booted title in 488 ms (30 settle frames); re-priced at boot:title: 0.0065 s/frame (was 0.0059), 20733 frames left + 0 s boot = 136 s against 14399 s of budget left
- events: t=0.87
- verdict: PASS
...
- actual: 6 x combat_quick: enemy hp 12.5/93.7 (13.4%), hits dealt [13.1, 12.7, 13.1, 14.1, 14.8, 13.3], largest 14.8
- events: t=207.28
- verdict: PASS
