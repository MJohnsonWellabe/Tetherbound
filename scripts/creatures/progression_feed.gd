...
## OP-0905-18's announce-once ledger, keyed by creature instance id. Per
## instance for the same reason the log is (D98 / MP_STATE_SEAM §1-§2): two
## players' parties must not share a "already told them" flag.
