...
## Cloudreach Phase 2 evidence: six real production-scene, third-person views
...
##     --script tools/capture_cloudreach_foundation.gd

const SCENE := preload("res://scenes/world/cloudreach_cliffs.tscn")
const OUT_DIR := "res://ralph/reports/CLOUDREACH-PHASE2-0904/shots"
const PERF_PATH := "res://ralph/reports/CLOUDREACH-PHASE2-0904/performance.json"
