...
## lower-face shelves, broken far-rim silhouette and authored overlook. Does
## not modify the shared named-location capture tool.
##
##   godot --path . --rendering-driver opengl3 --resolution 1280x800 \
##     --script tools/capture_long_water_bank_identity.gd -- \
##     --output=res://ralph/reports/MEADOWS-0912/final-long-water-03
