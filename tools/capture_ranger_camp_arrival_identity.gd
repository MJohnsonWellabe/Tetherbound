...
## Dedicated production-scene evidence for Abandoned Ranger Camp's ordinary
## spur arrival and collapsed-shelter identity. Does not edit the shared
...
const VIEWS := [
	{"name": "01-spur-arrival-day", "stand": Vector2(-245.0, 2250.0), "target": Vector2(-256.4, 2260.1), "time": "day", "aim_up": 1.2},
	{"name": "02-spur-arrival-night", "stand": Vector2(-245.0, 2250.0), "target": Vector2(-256.4, 2260.1), "time": "night", "aim_up": 1.2},
	{"name": "03-camp-standing-day", "stand": Vector2(-252.5, 2254.0), "target": Vector2(-257.0, 2259.0), "time": "day", "aim_up": 1.0},
	{"name": "04-camp-standing-night", "stand": Vector2(-252.5, 2254.0), "target": Vector2(-257.0, 2259.0), "time": "night", "aim_up": 1.0},
	{"name": "05-collapsed-shelter-day", "stand": Vector2(-245.0, 2247.0), "target": Vector2(-254.5, 2255.5), "time": "day", "aim_up": 1.15},
	{"name": "06-collapsed-shelter-night", "stand": Vector2(-245.0, 2247.0), "target": Vector2(-254.5, 2255.5), "time": "night", "aim_up": 1.15},
]
...
func _run() -> void:
	...
	camera.name = "RangerCampArrivalEvidenceCamera"
	camera.fov = FOV
	camera.far = 2000.0
	...
	var manifest := {
		...
		"named_location": "Abandoned Ranger Camp",
